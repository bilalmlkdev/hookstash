      ...
      <div className="mx-auto flex max-w-6xl items-center gap-6 px-6 py-3">
        ...
        <div className="flex flex-1 items-center justify-end gap-2">
          <a
            ...
            className="flex h-8 w-8 items-center justify-center rounded border border-border rounded-lg text-ink-soft  hover:border-border-strong hover:text-ink"
          >
            <HugeiconsIcon icon={GithubIcon} className="h-4.5 w-4.5" />
          </a>
